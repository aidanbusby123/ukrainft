...
export interface RouterControllerState {
    view: 'Account' | 'Connect' | 'ConnectingExternal' | 'ConnectingWalletConnect' | 'ConnectingSiwe' | 'Networks' | 'SwitchNetwork' | 'AllWallets' | 'WhatIsAWallet' | 'WhatIsANetwork' | 'GetWallet' | 'Downloads' | 'Transactions';
